...
game.import("character", function (lib, game, ui, get, ai, _status) {
				...
				content() {
					...
					next.ai = function (card) {
						if (effect < 0) {
							...
							if (nme == "shuiyanqijun" && trigger.targets.includes(player)) {
								return val;
							}
							return 0;
						}
	...
	get.typeimage(swd,'ontology/character')
	for(var i in swd.card){
		if(!swd.card[i].image) swd.card[i].image='extension/夜白神略/image/ontology/card/'+i+'.png'
	}
