...
game.import("character", function (lib, game, ui, get, ai, _status) {
	...
	get.typeimage(xianjian,'ontology/character')
	for(var i in xianjian.card){
		if(!xianjian.card[i].image) xianjian.card[i].image='extension/夜白神略/image/ontology/card/'+i+'.png'
	}
