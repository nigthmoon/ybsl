...
game.import("character", function (lib, game, ui, get, ai, _status) {
	...
	// for(var i in gujian.character){
	// 	gujian.character[i].img = 
	// }
	
	get.typeimage(gujian,'ontology/character')
	for(var i in gujian.card){
		if(!gujian.card[i].image) gujian.card[i].image='extension/夜白神略/image/ontology/card/'+i+'.png'
	}
