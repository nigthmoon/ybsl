...
game.import("card", function (lib, game, ui, get, ai, _status) {
	...
	for(var i in mtg.card){
		if (!mtg.card[i].cardimage) {
			if (mtg.card[i].fullskin) {
				mtg.card[i].image = "extension/夜白神略/image/ontology/card/" + i + ".png";
			} else {
				mtg.card[i].image = "extension/夜白神略/image/ontology/card/'+i+'.jpg";
			}
		}
