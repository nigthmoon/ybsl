...
const translate = {
	...
	ybsl_zhuanhuanka_info:'当你需要使用或打出牌时，你可以坍缩一张当前形态未坍缩的转换卡并使用或打出之。转换卡无法成为转化的目标牌。转换卡离开场上或因使用或打出而进入弃牌堆则转换。',
	...
	ybsl_hua: '化',
	ybsl_hua_info: '转换卡，此牌视为：一：任意牌。此牌转换时，若此时为最后一项，失去者可以增加一项任意牌。（同一张化至多九项）',
