...
const translate = {
	...
	yhky_cyluoyi:'裸衣',
	yhky_cyluoyi_info:'持恒技，出牌阶段开始时，你可弃置一张牌然后摸两张牌并展示之，若你弃置的牌或摸到的牌包含:基本牌，直到下回合开始，你使用【杀】或【决斗】造成的伤害+1；锦囊牌:本回合使用【杀】次数+1；装备牌，本回合使用【杀】无距离限制。',
	yhky_cyjiuxian:'救陷',
	yhky_cyjiuxian_info:'持恒技，出牌阶段限一次，你可以重铸x张牌(x为手牌与装备区数量之和的一半向上取整)，然后视为对一名角色使用【决斗】，此法对目标造成伤害时，你可以令你或攻击范围内一名角色回复1点体力并摸两张牌。',
	yhky_cyyinjun:'寅君',
