...
const translate = {
	...
	yhky_lzyjuekang:'珏抗',
	yhky_lzyjuekang_info:'持恒技。①游戏开始时，你获得20枚“道心”标记。②当你得到牌后/受到1点伤害后/造成1点伤害后，你获得5/10/15枚“道心”（上限为99枚）。③若你的“道心”数不小于25/50/75/99，你视为拥有〖战绝〗/〖凤魄〗/〖封缄〗/〖焚身〗。',
	...
	yhky_cylingwei:'凌威',
	yhky_cylingwei_info:'持恒技，①游戏开始时你获得20枚“凌人”值。②当你〖凌人〗猜对1/2/3时，你获得5/10/15点“凌人”值（上限为99）。③当你“凌人”值不小于25/50/75/99时获得〖裸衣〗/〖救陷〗/〖寅君〗/〖擒龙〗。',
	yhky_cyluoyi:'裸衣',
	...
	yhky_cyyinjun:'寅君',
	yhky_cyyinjun_info:'持恒技，当你使用对应实体牌均为你的手牌的杀或锦囊牌结算后，若目标为1，你可以视为对该目标使用一张无伤害来源的【杀】。本回合寅君次数大于体力上限时，该技能本回合失效。',
	yhky_cyqinlong:'擒龙',
	yhky_cyqinlong_info:'持恒技，限定技，出牌阶段，你可以令所有角色调整体力值为1并获得x点护甲(x为以此法减少的体力，你额外获得2点)，令场上获得坦诚相待光环（可以看见其他角色的手牌）。',
	yhky_cylingren:'凌人',
	yhky_cylingren_info:'持恒技，每回合限两次，<br>当你使用带有伤害类基本牌或普通锦囊牌指定目标后，你可以猜测其中的一个目标的手牌中是否有基本牌，锦囊牌或装备牌。若你猜中的项目数：≥1，此牌对该角色的伤害+1；≥2，你令该目标不可响应此牌；≥3，你从〖奸雄〗，〖行殇〗，〖恢拓〗选择一项获得。<br>当你成为其他角色伤害牌的目标时，你可猜测其是否含有基本、锦囊、装备，若你猜中的项目数：≥1，undefined；≥2，此牌对你伤害-1；≥3，弃置其至多2张牌。<br>以上以此法每猜对一项摸一张牌。',
	...
	yhky_cyzhanlong:'斩龙',
	yhky_cyzhanlong_info:'持恒技，每回合限一次，你使用杀或决斗的结算中，你可令目标角色（决斗改为对方）非锁定技失效。',
