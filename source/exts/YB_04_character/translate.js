...
// 宗族技，当你每回合首次使用一种类型的牌后，若你本回合未造成伤害，你可以令一名同族角色发动一个出牌阶段限一次的技能（不计入次数）。
	...
	*/
	...
	sgsk_jiabian:'驾辩',
	'sgsk_jiabian_info':'你可以令你的判定牌颜色相反。',
	//--------------------相柳
	sgsk_jiushou:'九首',
	...
	//--------------------精卫
	sgsk_xianmu:'衔木',
	'sgsk_xianmu_info':'其他角色弃置牌后，你可以选择其中一张，获得之或置入装备区任意栏。',
	sgsk_tianhai:'填海',
	'sgsk_tianhai_info':'出牌阶段限一次，你可以弃置四张花色各不相同的牌，然后依次选择至多四名角色，同时弃置这些角色各一张牌。然后若选择了自己，你回复一点体力，否则你失去一点体力。',
	sgsk_xianmux:'衔木',
	...
	//--------------------九天玄女
	sgsk_taolue:'韬略',
	'sgsk_taolue_info':'结束阶段开始时，你可以令一名角色摸一张牌并展示之，若为红桃，其回复一点体力，若为黑桃，其失去一点体力。',
	sgsk_xuanji:'玄机',
