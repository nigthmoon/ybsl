...
const translate = {
	...
	niya_youbo:'游波',
	niya_youbo_info:'一名角色流失一点体力时或黑色牌进入弃牌堆时，你可观看牌堆顶x张牌并记录点数之和为a，然后你可摸不大于log以2为底a为真数的最大值数张牌并清除游波记录的点数。以此法摸的牌等于当前回合角色体力上限时，你可减少其一点体力上限。（x为你的体力上限）',
	niya_anren:'暗刃',
	niya_anren_info:'锁定技，你对体力上限不小于你的角色使用牌时其不可响应且造成伤害后额外流失一点体力；你成为体力上限不大于你的角色为目标时，其须弃置一张黑色牌，否则此牌无效。',
	niya_xuantu:'玄途',
...
// 宗族技，当你每回合首次使用一种类型的牌后，若你本回合未造成伤害，你可以令一名同族角色发动一个出牌阶段限一次的技能（不计入次数）。
	...
	*/
	...
	ybsl_kamome:'鸥',
	'kamome_ybyangfan':'扬帆',
	'kamome_ybyangfan_info':'锁定技，游戏开始时，你将一张【旅行箱】置入你的装备区。当你获得此技能时，你分配四张手牌分别标记为“鹰”，“燕”，“隼”，“雀”（离开手牌区则移去标记）。当你失去带有标记的牌时或装备区内的牌时，你依次执行：若包含“鹰”，你卜算2；若包含“燕”，你对一名其他角色造成一点伤害；若包含“隼”，你从弃牌堆获得一张与“隼”相同花色的锦囊牌；若包含“雀”你回复一点体力；包含装备区内的牌，你获得牌堆顶X张牌并为这些牌分别标记（X为你手牌中缺少的标记数）（此效果不触发相关技能）。',
