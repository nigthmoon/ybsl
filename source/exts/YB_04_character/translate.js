...
const translate = {
	...
	niya_limu:'立牧',
	niya_limu_info:'出牌阶段，你可以将任意花色的牌当指定牌延时锦囊牌对自己使用，♦️为乐不思蜀，回复1体力；♠️为闪电，然后对一名角色造成1点雷电伤害；♣️为兵粮寸断，然后弃置一名角色至多2张牌；♥️望梅止渴，然后你摸2张牌。你的判定区有牌时，你对攻击范围内其他角色使用牌无限制。',

	niya_limu_info:'出牌阶段，你可以将任意花色的牌当指定牌延时锦囊牌对自己使用，♦️为【乐不思蜀】，回复1体力；♠️为【闪电】，然后对一名角色造成1点雷电伤害；♣️为【兵粮寸断】，然后弃置一名角色至多两张牌；♥️【望梅止渴】，然后你摸两张牌。你的判定区有牌时，你对攻击范围内其他角色使用牌无限制。',
	niya_tushe:'图射',
	niya_tushe_info:'当你使用或成为非装备牌目标时，你摸x张牌，然后直到本回合结束时，下次发动此技能时手牌须没有基本牌（x为此牌目标数）。',
	niya_wangmeizhike:'望梅止渴',
	niya_wangmeizhike_bg:'梅',
	niya_wangmeizhike_info:'对自己使用，置入自己判定区，判定阶段如果不为♦️，你选择回复1或者摸两张牌。',
	...
	zxunnamed_qinglan_info : '锁定技，每回合每名角色限一次，你使用牌指定其他角色为唯一目标后，其选择一项：1.弃置一张牌并视为使用一张【酒】，2.将牌堆顶的牌当做【折戟】对自己使用并回复一点体力，3.令你摸两张牌且本回合此技能失效。',
	zxunnamed_lingbo : '凌波',
	zxunnamed_lingbo_info : '转换技，出牌阶段，阴：你可以将一名角色装备区内的牌当做【无中生有】对其使用 阳：你可以令一名角色将你装备区内的牌当做【杀】使用。',
	...
	ybsl_clanxingzu: '兴族',
	ybsl_clanxingzu_info: '宗族技，当你每回合首次使用一种类型的牌后，若你本回合未造成伤害，你可以令一名同族角色发动一个“出牌阶段限一次的技能”（不计入次数）。', //可能些微调整
	...
	ybsl_lykangming: '抗命',
	ybsl_lykangming_info: '出牌阶段限一次，你可以进行一次判定。然后你可以弃置一张花色与判定结果相同的牌。若如此做，本回合〖夭厄〗失效。若弃置牌点数也与之相同，则你减1点体力上限。',
	...
	ybsl_ljguihang:'归航',
	ybsl_ljguihang_info:'使命技，锁定技，当你失去手牌后，若你手牌数小于体力上限，你获得【影】补充至体力上限；成功：准备阶段，若你手牌中均为【影】，你弃置所有手牌，获得等量“橘”，并获得技能〖怀橘〗，然后摸等量手牌（至多5张），然后增加1点体力上限并回复1点体力。',
	// 修改后的方案：
...
// 宗族技，当你每回合首次使用一种类型的牌后，若你本回合未造成伤害，你可以令一名同族角色发动一个出牌阶段限一次的技能（不计入次数）。
	...
	*/
	...
	ybsl_yedun:'夜遁',
	ybsl_yedun_info:'锁定技，当你每回合首次受到伤害后，你需选择一名其他角色（不能是本局游戏以此法选择过的角色），其需选择：①令你摸三张牌，然后你本回合不能成为黑色牌目标；②令你失去1点体力，然后你本局游戏获得〖失路〗。',
	ybsl_yedunx:'夜遁',
	ybsl_yedunx_info:'锁定技，当你每回合首次受到伤害后，你需选择一名其他角色（不能是本局游戏以此法选择过的角色），其需选择：①令你摸三张牌，然后你本回合不能成为黑色牌目标；②令你失去1点体力，然后你本局游戏获得〖失路〗（可以获得多个）。',
	ybsl_shilu:'失路',
	...
	hairi_zhongxia:'终夏',
	hairi_zhongxia_info:'使命技，当你需要使用一张基本牌时，你可以弃置所有手牌（至少一张），若你以此法弃置的牌花色各不相同，你视为使用之，若你以此法弃置的牌数等于你已损体力值或体力上限，你加1点体力上限（若未成功使用目标牌，此技能本回合不能再用）<br>成功：准备阶段，若你的体力上限不小于5，你选择一项：①获得技能〖炒饭〗，并恢复所有已废除装备栏。②将体力上限调整为1，并重置〖终夏〗。<br>失败：当你死亡时，你令一名其他角色获得〖终夏〗。',
	...
	//-------------------------------周瑜小乔
	'ybsl_xianyin':'弦音',
	'ybsl_xianyin_info':'转换技，（括号内的阴阳为〖鸾鸣〗的形态）<br/>阴（阴）：当你因弃置而失去一张黑桃牌时，你可令一名角色下个摸牌阶段额外摸一张牌；（若你没有〖鸾鸣〗或〖鸾鸣〗已使用则改为黑色牌）<br/>阴（阳）：当你因弃置而失去一张梅花牌时，你可令一名角色回复1点体力；（若你没有〖鸾鸣〗或〖鸾鸣〗已使用则改为黑色牌）<br/>阳（阴）：当你因弃置而失去一张红桃牌时，你可令一名角色失去1点体力；（若你没有〖鸾鸣〗或〖鸾鸣〗已使用则改为红色牌）<br/>阳（阳）：当你因弃置而失去一张方块牌时，你可令一名角色下个摸牌阶段少摸一张牌。（若你没有〖鸾鸣〗或〖鸾鸣〗已使用则改为红色牌）',
	'ybsl_luanming':'鸾鸣',
	'ybsl_luanming_info':'转换技，每回合限一次，当你可以使用牌时，你可以弃置一黑一红共两张牌，然后：阴：视为使用其中的黑色牌并额外执行一次；阳：视为使用其中的红色牌并额外执行一次。<br><span class=yellowtext>注意：此技能不能用于响应其他牌，更不能在别人濒死时用【桃】选择其为目标！</span>',
	...
	sgsk_changcao:'尝草',
	'sgsk_changcao_info':'出牌阶段，你可展示牌堆顶的一张牌并获得之，若为黑桃，你失去1点体力。',
	sgsk_changcaox:'尝草',
	'sgsk_changcaox_info':'出牌阶段限X次（X为你体力值且至多为5），你可展示牌堆顶的一张牌并获得之，若为黑桃，你失去1点体力。',
	//--------------------轩辕
	sgsk_xiude:'修德',
	...
	//--------------------蚩尤
	sgsk_zhanshen:'战神',
	'sgsk_zhanshen_info':'锁定技，出牌阶段，每当你使用一张牌后，你须分配1点伤害；回合结束时，若你未于此回合杀死至少一名角色，你失去1点体力。',
	sgsk_shizhan:'嗜战',
	'sgsk_shizhan_info':'锁定技，当你于出牌阶段使用牌时，若此牌点数为你本阶段使用牌的唯一最大/最小点数，你对一名体力值大于等于你/小于等于你的角色造成1点伤害；回合结束时，若你本回合没有杀死过角色，所有本回合受到过你伤害的其他角色依次对你造成1点伤害。',
	//--------------------风后
	sgsk_sinan:'司南',
	'sgsk_sinan_info':'锁定技，你的红桃判定牌生效后，你回复1点体力。',
	sgsk_shence:'神策',
	...
	'sgsk_taolue_info':'结束阶段开始时或当你受到伤害后，你可以令一名角色摸一张牌并展示之，若为红桃，其回复1点体力。',
	sgsk_xuanji:'玄机',
