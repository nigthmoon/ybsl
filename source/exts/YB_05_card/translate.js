...
const translate = {
	...
	'ybsl_lanhua':'兰',
	'ybsl_lanhua_info':'出牌阶段，对至多两名角色使用，目标增加1点体力上限。追加：然后若目标数为小于2，则目标再摸一张牌，否则销毁此牌。',
	'ybsl_lanhua_append':'兰花的兰。有毒慎食！',
	'ybsl_zhuzi':'竹',
	'ybsl_zhuzi_info':'出牌阶段，对至多两名角色使用，目标获得1点护甲。追加：然后若目标数为小于2，则目标再摸一张牌，否则销毁此牌。',
	'ybsl_zhuzi_append':'竹花的竹（好像哪里不对）。有毒慎食！',
	'ybsl_juhua':'菊',
	'ybsl_juhua_info':'出牌阶段，对至多两名角色使用，目标回复1点体力。追加：然后若目标数为小于2，则目标再摸一张牌，否则销毁此牌。',
	...
	'ybsl_dafeng':'大风',
	'ybsl_dafeng_bg':'风',
	'ybsl_dafeng_info':'出牌阶段，对任意一名角色使用，其需弃置一张基本牌，否则受到你造成的1点伤害。',
	'ybsl_luolei':'落雷',
	'ybsl_luolei_bg':'雷',
	'ybsl_luolei_info':'出牌阶段，对任意一名角色使用，其需弃置一张装备牌，否则受到你造成的1点雷属性伤害。',
	'ybsl_duboom':'毒爆',
