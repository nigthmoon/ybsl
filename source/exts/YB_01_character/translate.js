...
const translate = {
	...
	'ybsl_cu_info':'出牌阶段，对一名任意角色使用，或当你进入濒死状态时，你可以对自己使用，令目标回复一点体力（若此牌没有实体牌则不回血），然后弃置其一张牌。此牌因弃置而离开手牌区时，你需弃置一张手牌。',
	ybsl_tang:'糖',
	ybsl_tang_used:'糖',
	ybsl_tang_info:'出牌阶段，对一名任意角色使用，或当任意角色进入濒死状态时，你可以对其使用，令目标回复一点体力（当场上角色声明使用牌后，若此牌的实体牌中仅包含【糖】，则需要另外选择一张手牌加入实体牌，然后若仍然仅包含【糖】，则需要继续选择，然后此牌的基础数值改为此牌包含的【糖】数）。',
	// ybsl_tang_info:'出牌阶段，对一名任意角色使用，或当任意角色进入濒死状态时，你可以对其使用，令目标回复一点体力（若此牌有实体牌则在你声明使用此牌后，需要选择一张手牌加入该牌的实体牌中）。',
	...
	ybsl_lingshi:'零食',
	ybsl_minimahua:'迷你麻花',
	ybsl_minimahua_info:'出牌阶段，对自己使用，增加1饱食度，然后获得2点护甲。',
	ybsl_yumiruantang:'玉米软糖',
	ybsl_yumiruantang_info:'出牌阶段，对自己使用，增加1饱食度，然后回复2点体力。可救人。',
	ybsl_weihuabinggan:'威化饼干',
	ybsl_weihuabinggan_info:'出牌阶段，对自己使用，增加1饱食度，然后增加1点体力上限。',
	ybsl_qiaokelibang:'巧克力棒',
	ybsl_qiaokelibang_info:'出牌阶段，对自己使用，增加1饱食度，然后摸3张牌。',
	// _ybsl_baoshidu:'饱食度',
	...
	QQQ002_xiangyun:'香陨',
	QQQ002_xiangyun_info:'使命技，游戏开始时，你将牌堆顶X张牌置于武将牌上称为“香”，X为场上角色数一半向下取整。<br>①每轮开始时，你需将至少一张花色各不相同的牌（二或更多周目则没有花色限制）置入“香”，然后摸 等量（二或更多周目则改为双倍）的牌。<br>②场上角色的出牌阶段开始时，若其为你或手牌数小于体力值，其可以获得你的一张“香”，<br>③成功：准备阶段，若你的“香”包含三种花色（二或更多周目则改为四种），则你获得所有“香”，并回复一点体力，然后在本轮结束时重新激活并令周目数+1。<br>④失败：准备阶段，若你没有“香”，你失去一点体力并重铸所有手牌，然后在本轮结束时重新激活（不过不增加周目数）。',
	'yb002_yishui':'忆水',
	...
	yb003_yeyan:'夜宴',
	yb003_yeyan_info:'锁定技，游戏开始时，你在牌堆中加入迷你麻花，巧克力棒，玉米软糖，威化饼干。(每种牌两张，牌堆数量每增加54，每种牌额外加一张)',
	yb003_xiangyan:'享宴',
	yb003_xiangyan_info:'锁定技，你使用零食时可以额外指定一名其他角色为目标；其他角色使用零食可以额外指定你为目标。',
	// 'yb003_toushi':'偷食',
	...
	*/
	...
	'yb010_zhusui':'珠碎',
	'yb010_zhusui_info':'觉醒技，当你进入濒死状态时，你增加一点体力上限，回复一点体力，失去〖无猜〗，获得〖星显〗',
	'yb010_xingxian':'星显',
	...
	//-----------------------SP满城柒
	'yb016_shanbiao':'善表',
	'yb016_shanbiao_info':'锁定技，转换技，回合结束时或当你武将牌翻面时，阳：你摸两张牌；阴，你受到当前回合角色造成的一点伤害。<br>你阳状态下，受到的伤害-1；<br>你阴状态下，造成的伤害-1。',
	'yb016_jiushi':'酒诗',
	...
	'yb017_chuanxinx':'传信',
	'yb017_chuanxinx_info':'锁定技，一名角色的结束阶段开始时，当前回合角色本回合使用的牌每有一种颜色,你便选择一项（无色牌不计入）：①摸一张牌，②视为使用一张其本回合使用过的一张非【装备及延时】牌。',
	'yb017_chuanxiny':'传信',
	'yb017_chuanxiny_info':'锁定技，一名角色的结束阶段开始时，当前回合角色本回合使用的牌每有一种颜色,你便选择一项：①摸一张牌，②视为使用一张其本回合使用过的一张非【装备及延时】牌。',
	'#ext:夜白神略/audio/character/yb017_chuanxin1':'你的心意，我来替你传达。',
	'yb017_zuigui':'醉归',
	'yb017_zuigui_info':'锁定技，弃牌阶段开始时，你视为使用一张酒；你使用的酒无次数限制，且效果改为：回复一点体力，然后令目标附加酒状态；你的酒状态效果改为，本回合下一张伤害牌伤害+1。',
	...
	'yb020_zhuangrong':'妆容',
	'yb020_zhuangrong_info':'锁定技，游戏开始时，你从牌堆装备两张不同副类型的装备；当你造成或受到伤害后，你选择：①摸两张牌，每回合限选X次，X为装备区黑色牌的数量；②回复一点体力，每回合限选Y次，Y为装备区红色牌的数量。',
	'yb020_zhuangrongx':'妆容',
	'yb020_zhuangrongx_info':'当你使用或打出红色牌时，你可令一名角色回复一点体力。',
	//-----------------------刘域楓（待写）
	'yb021_shusuan':'数算',
	...
	yb033_qijuez:'泣绝',
	yb033_qijuex_info:'转换技。出牌阶段，①你可以摸两张牌，然后失去一点体力，②你可以弃置三张手牌，恢复一点体力；③若你区域内的牌数不小于体力值，你可以弃置区域内所有牌，然后摸X张牌，X为你体力上限，至多为5。',
	yb033_qijue:'泣绝',
	
	// yb033_qijue_info:'锁定技，出牌阶段开始时，你选择一项：失去一点体力，受到一点伤害，弃置一张牌。锁定技，当你失去体力后，①你下次失去体力后，②恢复此数值*2点体力，然后③弃置一张手牌；当你受到伤害后，①你下次受到伤害后，②摸此数值*3张牌，然后③弃置一张手牌；当你弃置牌后，①你下次弃置牌后，②对场上角色各造成一点伤害，然后③你令场上角色各失去一点体力。',
	yb033_qijue_info:'锁定技，出牌阶段开始时，你选择一项：失去一点体力，受到一点伤害，弃置一张牌。锁定技，当你失去体力后，①你下次失去体力后，②恢复此数值*2点体力，然后③弃置一张手牌；当你受到伤害后，①你下次受到伤害后，②摸此数值*3张牌，然后③失去一点体力；当你弃置牌后，①你下次弃置牌后，②对场上角色各造成一点伤害，然后③令一个数字之后的效果向前错位。',
	// yb033_qijue_info:'锁定技，重置技<br>出牌阶段开始时，你选择一项：失去一点体力，受到一点伤害，弃置一张牌，打出一张牌。<br>当你再次执行此操作时（可以由其他途径触发，但严格限制牌数或伤害数，不限制来源），你摸三张牌。<br>若牌堆剩余牌数小于此次摸牌数，则改为失去一点体力。',
	//-------------------梦周怜渊--------------//
	'yb034_sanmeng':'散梦',
	...
	//-------------------张汨----------------//
	yb047_xundu:'寻妒',
	yb047_xundu_info:'每回合限一次，对每名角色限一次，当有其他角色于摸牌阶段外获得牌时，你可以展示之，然后展示手牌，若其中没有与你手牌同名的牌，你令该角色选择一项<br/>①受到你造成的一点伤害②将这些牌改为你获得之。<br/>若有同名牌，你可以弃置手牌中所有同名的牌，然后本次选项由你选择。',
	yb047_efei:'恶诽',
	yb047_efei_info:'每回合限一次，①当其他角色使用牌时，你可以弃置一张同名牌，令此牌无效；②当其他角色受到卡牌伤害后，你可以弃置一张与造成伤害的牌牌名相同的牌，然后你令此牌追加造成一点伤害。',
	yb047_pomen:'破梦',
	yb047_pomen_info:'每回合限一次，当其他角色弃置牌时，你可以令其收回此牌（多张牌则由你选择一张令其收回），视为其对自己造成一点由此牌造成的伤害；当以此法选择的牌致人死亡时，你获得此牌。',
	yb047_pomeng:'破梦',
	yb047_pomeng_info:'当其他角色弃置牌时，你可以令其收回此牌（多张牌则由你选择一张令其收回），视为其对自己造成一点由此牌造成的伤害；当以此法选择的牌致人死亡时，你获得此牌。',
	//--------------------吴爽----------------//
	'yb048_ningyuan':'凝元',
	...
	*/
	yb121_yuanjie:'缘介',
	yb121_yuanjie_info:'每回合限一次，当有角色造成伤害后，你可以令受伤角色回复一点体力，然后伤害来源摸两张牌，你摸X张牌，X为场上因此回复过体力的角色数。',
	yb121_tiandu:'天妒',
	yb121_tiandu_info:'锁定技，准备阶段，你进行一次判定，若结果为伤害牌，你受到一点该牌造成的伤害；当你的判定牌生效后，你获得之。',
