...
const translate = {
	...
	'yb001_minglun_info':'锁定技，回合开始时，你展示牌堆顶一张牌并放在武将牌上（至多四张）。根据“命轮”的花色，你视为拥有技能：<br>黑桃：〖栖月〗；红桃：〖旅心〗；<br>梅花：〖折叶〗；方块：〖忆水〗。<br>结束阶段，若“命轮”包含相同花色或四种花色，则你需弃置所有“命轮”或失去1点体力。',
	...
	'yb004_tianqi':'天祈',
	'yb004_tianqi_info':'锁定技，当你对其他角色造成伤害后，你进行判定：若伤害不大于1，且结果为红色，你回复1点体力或摸一张牌；若伤害大于1，且结果为黑色，你失去1点体力并摸一张牌。当你受到伤害后，你进行判定，若结果为黑色，你摸x+1张牌，否则你回复x-1点体力（x为此次伤害值）（此技能不可触发〖界雷击〗）',
	'yb004_shangyuan':'殇怨',
	'yb004_shangyuan_info':'觉醒技，当你造成伤害致人死亡后，若伤害大于1，则你失去〖巫女〗，修改〖天祈〗（修改后的技能可以触发〖界雷击〗），然后选择回复1点体力或摸两张牌，最后获得〖玉洁〗。',
	...
	'yb005_jieshen':'洁身',
	'yb005_jieshen_info':'准备阶段，你可以失去1点体力上限，然后获得以下技能之一：〖无猜〗，〖折叶〗，〖玉洁〗。然后你摸三张牌。',
	'yb005_wucai':'无猜',
	...
	*/
	...
	'yb010_zhusui':'珠碎',
	'yb010_zhusui_info':'觉醒技，当你进入濒死状态时，你增加1点体力上限，回复1点体力，失去〖无猜〗，获得〖星显〗',
	'yb010_xingxian':'星显',
	...
	'yb011_chenxing':'尘醒',
	'yb011_chenxing_info':'使命技，准备阶段①成功：若你已废除装备栏不小于三个（原文是全部，此处降低难度），你增加1点体力上限，回复1点体力，然后获得技能〖姻梦〗；②失败：若你已废除装备栏小于三个，且你的“痕”不小于3，则你失去1点体力上限，失去〖空白〗，获得〖恨〗。',
	'yb011_yinmeng':'姻梦',
	...
	'yb014_shihua':'诗华',
	'yb014_shihua_info':'觉醒技，准备阶段或结束阶段，若你手牌数小于体力值，则你摸等同体力上限的牌数，然后失去1点体力上限，获得〖窥梦〗',
	'yb014_kuimeng':'窥梦',
	...
	'yb014_yazhi':'崖止',
	'yb014_yazhi_info':'神或野势力技，锁定技，你造成的伤害+1；当你造成伤害致人濒死后，若你未受伤，你失去一1体力，否则失去1点体力上限；当你击杀其他角色后，你回复1点体力或摸两张牌。',
	//-----------------------神夜白
	'yb014_shizhui':'诗追',
	...
	'yb021_qiujiao':'求教',
	'yb021_qiujiao_info':'出牌阶段限一次或当你受到一次伤害后，你可以令一名其他角色交给你一张牌，并令你下一次〖数算〗的X值+1。',
	//-----------------------盐（待写）
	'yb022_yiduan':'臆断',
	...
	'yb022_duanxiang':'断想',
	'yb022_duanxiang_info':'每回合限一次，当有角色受到伤害后，你可以令受伤角色选择一项：①，弃置2X张牌（牌数不够则不能选），然后回复X点体力；②，失去X点体力上限，然后摸X张牌。（X为其已损体力值。）',
	...
	'yb022_duanxiangxx_info':'觉醒技，当你进入濒死状态时，若你〖臆断〗记录的牌名大于X（X为场上玩家数且最小为4），你失去〖臆断〗，然后增加1点体力上限，回复1点体力。',
	//-----------------------孙立新
	yb023_jiang:'激昂',
	...
	yb025_tuiqiao:'蜕壳',
	yb025_tuiqiao_info:'锁定技，准备阶段，已损失体力值大于三，则你失去3点体力上限，然后摸三张牌。',
	yb025_chengyin:'成荫',
	...
	//-------------------小慧--------------//
	'yb033_huiyue':'慧月',
	'yb033_huiyue_info':'锁定技，回合开始时，若你体力值为绿色（总体力2/3以上），你获得技能〖淑慧〗；<br/>当你受到伤害时，你获得技能〖隅泣〗，若此时你已获得〖淑慧〗，你令〖淑慧〗添加追加效果”；<br/>回合结束阶段，若你本回合使用的牌的类别不小于2，你获得技能〖旅心〗；<br/>每轮限一次，回合结束阶段，若你本回合使用的牌类别不小于3，你额外执行一个回合。',
	'yb033_shuhui':'淑慧',
	// 'yb033_shuhui_info':'回合开始时，你可以弃置一张手牌，令一名角色回复1点体力。（追加描述：否则你令至多X名其他角色各失去1点体力，X为你本次弃牌数。）然后你将被此技能选中的其他角色记录为“诉”。',
	'yb033_shuhui_info':'回合开始时，你可以弃置一张手牌，并令一名角色回复或失去1点体力。（追加描述：然后你展示牌堆顶一张牌，将〖隅泣〗任意一个数字改为该牌点数，不会低于原数字且至多为当前最低的数字+2）。',
	'yb033_yuqi':'隅泣',
	...
	'yb035_liuwang':'流亡',
	'yb035_liuwang_info':'限定技，当你进入濒死状态时，你可以回复体力至1，然后从游戏外抽取四张主公武将并选择其一，获得其武将牌上所有技能，然后获得技能〖威严〗。',
	...
	'yb036_chongzheng':'重整',
	'yb036_chongzheng_info':'限定技，准备阶段或结束阶段或濒死求【桃】时，你可以回复1点体力，然后摸两张牌，并重置〖前进〗。',
	'yb036_aoxiang':'翱翔',
	...
	'yb037_guiling':'龟灵',
	'yb037_guiling_info':'锁定技，若你未装备防具，则当你受到大于1的伤害时，该伤害减为1；当你脱离濒死状态时，若你拥有〖咳血〗，则修改〖咳血〗（已修改到红桃则改为删除）；若你因〖咳血〗而进入濒死状态，则减1点体力上限并回复体力至上限。（体力上限若不大于三则不减）',
	//-------------------梦忆滕叔颖武宁--------------//
	'yb038_sanmeng':'散梦',
	...
	'yb038_fusheng':'复生',
	'yb038_fusheng_info':'觉醒技，当你进入濒死状态时，若你泉路计数小于3次，你减Y点体力上限，否则你增加(Y+1)点体力上限（Y为泉路计数-2的绝对值）。然后回复Z点体力（Z为泉路计数-2且至少为1），失去〖泉路〗，获得〖生路〗和〖恩许〗。若此次濒死没有成功救回，则你令一名其他角色获得【生路】',
	'yb038_fushengxx':'复生',
	'yb038_fushengxx_info':'觉醒技，当你进入濒死状态时，立即归还因〖泉路〗而失去的体力值和体力上限。然后增加两点体力上限，并获得〖往愿〗和〖恩许〗，最后清除泉路计数。若此次濒死没有成功救回，则你令一名其他角色获得【生路】',
	'yb038_wangyuan':'往愿',
	'yb038_wangyuan_info':'锁定技，回合结束后，你归还因〖泉路〗而失去的体力值和体力上限，然后若你泉路计数为3及以上，你移去3点计数，然后增加1点体力上限。',
	'yb038_enxu':'恩许',
	...
	//--------------------秋儿----------------//
	'yb053_lvxin':'孤旅',
	'yb053_lvxin_info':'锁定技，若你未拥有〖旅心〗，则视为你拥有〖旅心〗；<br>当你发动〖旅心〗摸牌时，你可以弃置之，改为回复1点体力（每种类型每回合限一次）或令你本回合手牌上限+1。',
	'yb053_yinren':'隐忍',
	...
	'yb067_kuiyi':'溃忆',
	'yb067_kuiyi_info':'忆势力技，结束阶段，你可以弃置所有手牌，定义X为所弃牌数，然后根据所弃花色依次执行：<br/>1，令至多X名角色各摸一张牌；<br/>2，令至多X名角色各回复1点体力；<br/>3，令至多X名角色增加1点体力上限；<br/>4，令一名任意角色摸3张牌；<br/><i>若你本回合发动过〖缠情〗，则此技能指定本回合〖缠情〗角色为目标时，其在此技能流程结束时，额外执行一次被分配到的最后一项。</i>',
	//--------------------清月----------------//
	'yb068_mingzhu':'明珠',
	...
	yb070_fuyi:'傲寒',
	yb070_fuyi_info:'出牌阶段限一次或准备阶段或当你进入濒死状态时，你可以移去你列表中第一个技能，然后进行一次TW〖扶汉〗，势力范围为神，忆，梦，抽取数量为场上存活角色数且至少为4，{将池排除掉神夜白，神贾诩，线下神马超}，然后若你体力值为全场最低，则回复1点体力。',
	//-------------------071faraway
	'ybsl_xinghen':'星痕',
