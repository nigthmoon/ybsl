...
const translate = {  
	...
	'ybmjz_rende':'仁德',
	'ybmjz_rende_info':'出牌阶段限一次，你可以将任意张手牌置入仁库，同时指定至多等量其他角色，你令他们各摸两张牌；每回合限一次，你可以将一张仁库牌当一张基本牌使用；当仁库牌溢出时，你可将溢出牌分配给其他角色，然后获得牌的角色可以“拥戴”你（已拥戴改为可以令你恢复一点体力）；每局限一次，准备阶段，若存活的“拥戴”你的角色大于存活角色数一半，你加一点体力上限，回复一点体力，获得你未拥有的主公技。',
	// 'ybmjz_rende_info':'出牌阶段限一次，你可以将任意张手牌或仁库中的牌交给一名其他角色，然后声明一个基本或非延时锦囊牌，其可以展示一张手牌令此牌视为之。若如此做，你可以回复1点体力或视为使用你声明的牌。',
	'ybmjz_xiemin':'携民',
	'ybmjz_xiemin_info':'主公技，每回合每名角色限一次，其他角色使用有实体牌的【视为或转化牌】或【杀】后，其可以将位于弃牌堆的此牌置入仁库，然后若其不为蜀势力，你可令其改为蜀势力，否则你可以发动〖技一〗的第一句。',
	ybmjz_guanyu:'名将关羽',
