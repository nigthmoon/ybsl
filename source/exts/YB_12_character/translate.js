...
const translate = {
	...
	sgsxjxfzmnl_dcyingtu_info: "每回合限一次。当<span class=firetext>除你以外的角色</span>于摸牌阶段外得到牌后，你可以获得其一张牌，然后将一张牌交给<span class=firetext>另一名其他角色</span>。若你给出的牌为装备牌，则其使用之。",
	...
	sgsxjxfzmnl_xiecui_info: "当有角色于回合内<span style=\"text-decoration: line-through;\">第一次</span>因执行牌的效果而造成伤害时，你可以令此伤害+1。若其势力为吴，则该角色获得此伤害牌对应的实体牌，且其本回合的手牌上限+1<span class=yellowtext>，再其回合结束前你失去此技能</span>。",
	...
	sgsxjxfzmnl_dcqiqin_info: "锁定技。①游戏开始时，你将手牌标记为“琴”。②你的“琴”牌不计入手牌上限。③准备阶段，你获得位于弃牌堆的所有“琴”。然后你可更改手牌重点饿“琴”标记，你的“琴”标记牌上限为X（X为你的体力值上线）",//原文就写的上线，去殴打作者去，别怼咕我
	sgsxjxfzmnl_dcweiwan: "媦婉",
	sgsxjxfzmnl_dcweiwan_info: "出牌阶段限一次，你可以弃置一张“琴”并随机获得一名其他角色区域内花色与此牌不相同的牌<span style=\"text-decoration: line-through;\">各一张</span>，若你获得了：一张牌，其失去1点体力；两张牌，本回合你对其使用牌无距离和次数限制；三张牌，<span class=yellowtext>执行1，2项且</span>本回合你不能对其使用牌；<span class=yellowtext>四张牌，执行3项且其本轮技能失效</span>。",

	sgsxjxfzmnl_dc_sb_simayi: "阴间新杀谋司马懿",
	sgsxjxfzmnl_dc_sb_simayi_prefix: "阴间新杀谋",
	sgsxjxfzmnl_dcsbquanmou: "权谋",
	sgsxjxfzmnl_dcsbquanmou_info: "转换技。①游戏开始时，你可以转换此技能状态；②出牌阶段每名角色限一次，你可以令一名<span style=\"text-decoration: line-through;\">攻击范围内的</span>其他角色交给你一张牌。阳：当你于本阶段内下次对其造成伤害时，取消之；阴：当你于本阶段内下次对其造成伤害后，你可以选择<span style=\"text-decoration: line-through;\">除其外的</span>至多三名其他角色，对这些角色依次造成1点伤害。",
	sgsxjxfzmnl_dcsbpingliao: "平辽",
	sgsxjxfzmnl_dcsbpingliao_info: "锁定技。当你声明使用【杀】时，你令此【杀】的目标对其他角色不可见，且你令攻击范围内的其他角色依次选择是否打出一张红色基本牌。所有角色选择完成后，此牌的目标角色中没有以此法打出牌的角色本回合内无法使用或打出手牌<span class=yellowtext>且受到的伤害+1</span>；若有不为此牌目标的角色以此法打出了牌，则<span class=yellowtext>每打出一张基本牌</span>你摸两张牌。<span class=firetext>你对拥有“权谋”标记的角色使用牌无距离和次数限制。</span>",

	sgsxjxfzmnl_mb_zhangfen: "阴间手杀张奋",
	sgsxjxfzmnl_mb_zhangfen_prefix: "阴间手杀",
	sgsxjxfzmnl_mbquchong: "渠冲",
	sgsxjxfzmnl_mbquchong_effect: "阴间大攻车",
	sgsxjxfzmnl_mbquchong_info: `<span class=yellowtext>⓪摸牌阶段，你额外摸当前轮数的牌；</span>①出牌阶段，你可以重铸装备牌。<span style=\"text-decoration: line-through;\">②一名角色的回合结束时，你将弃牌堆中的所有装备移出游戏，然后获得等量的铸造值。</span>③出牌阶段开始时，若场上：没有【大攻车】，则你可以<span style=\"text-decoration: line-through;\">依次消耗0、2、5、5点铸造值，</span>从${get.poptip("sgsxjxfzmnl_dagongche_attack")}和${get.poptip("sgsxjxfzmnl_dagongche_defend")}中选择一个令一名角色获得（你任选此牌花色和点数）并令其使用此牌；有【大攻车】，则你可以移动场上的一张【大攻车】（可替换原装备）（小说里描述：你可以任意移动大攻车。但是我觉得太傻比了）。`,
	sgsxjxfzmnl_mbxunjie: "逊节",
	sgsxjxfzmnl_mbxunjie_info: "锁定技，当你受到<span class=firetext>伤害时</span>，若场上没有【阴间大攻车】，则你进行一次判定，若结果为红色，则此伤害<span class=firetext>防止之</span>。",
	sgsxjxfzmnl_dagongche_attack: "阴间大攻车·攻",
	sgsxjxfzmnl_dagongche_defend: "阴间大攻车·守",
	sgsxjxfzmnl_dagongche_attack_skill: "阴间大攻车",
	sgsxjxfzmnl_dagongche_defend_skill: "阴间大攻车",
	sgsxjxfzmnl_dagongche_attack_info: "<span style=\"text-decoration: line-through;\">②此牌拥有2点耐久度，耐久度为0时销毁此牌。</span>①当此牌进入你的装备区时，弃置你装备区里的其他牌。②其他装备区进入你的装备区前，改为将这些牌置于弃牌堆。③当你对一名角色造成伤害时，你可<span style=\"text-decoration: line-through;\">减少1点此牌的耐久度，</span>令此伤害+X（X为游戏轮数<span style=\"text-decoration: line-through;\">且至多为3</span>）。④当此牌不因〖渠冲〗离开装备区时，<span style=\"text-decoration: line-through;\">减少1点此牌的耐久度</span>并防止之。",
	sgsxjxfzmnl_dagongche_defend_info: "<span style=\"text-decoration: line-through;\">②此牌拥有4点耐久度，耐久度为0时销毁此牌。</span>①当此牌进入你的装备区时，弃置你装备区里的其他牌。②其他装备区进入你的装备区前，改为将这些牌置于弃牌堆。③当你受到伤害时，<span style=\"text-decoration: line-through;\">减少X点此牌的耐久度，</span>令此伤害-X（X为<span class=firetext>游戏轮数</span>）。④当此牌不因〖渠冲〗离开装备区时，减少1点此牌的耐久度并防止之。",
	...
	sgsxjxfzmnl_yaoyan_info:'当你成为其他角色【杀】的目标时，你可以弃置一张手牌，将此【杀】转移给琪攻击范围内的一名其他角色。。',
	...
	sgsxjxfzmnl_liyong_info: "锁定技，你使用【杀】制定目标后，若此未造成伤害，你失去1点体力，并将此【杀】收回。若此【杀】造成伤害，则你失去一点体力，且令手中伤害牌造成的伤害+1。",
	...
	sgsxjxfzmnl_dcchenlve_info: "限定技。出牌阶段，你可以将牌堆、弃牌堆、场上及其他角色的手牌区里的所有“死士”置入处理区，然后你获得这些牌。若如此做，你获得如下效果：1.此阶段结束时，你将这些牌移出游戏，并重新发动〖散士〗，标记“死士”牌；<span style=\"text-decoration: line-through;\">2.当你死亡时，你将所有以此法移出游戏的“死士”置入弃牌堆。</span>",

	
	sgsxjxfzmnl_xuelingyun: "阴间薛灵芸",
	sgsxjxfzmnl_xuelingyun_prefix: "阴间",
	sgsxjxfzmnl_dcxialei: "霞泪",
	sgsxjxfzmnl_dcxialei_info: "当你的红色牌进入弃牌堆后，你可以观看牌堆顶的三张牌，获得其中的一张牌，且可以将其余牌置于牌堆底。然后你本回合以此法观看的牌数-1。",
	sgsxjxfzmnl_dcanzhi: "暗织",
	sgsxjxfzmnl_dcanzhi_info: "出牌阶段或当你受到伤害后，你可以判定，若结果为红色，你重置〖霞泪〗的观看牌数<span class=yellowtext>并摸一张牌</span>；若结果为黑色，然后你可以令一名<span style=\"text-decoration: line-through;\">非当前回合</span>角色获得本回合进入弃牌堆的两张牌。<span class=firetext>当黑色判定次数达到X是，此技能本回合失效（X为本局游戏人数）</span>",
	...
	sgsxjxfzmnl_simazhao: "阴间SP司马昭",
	sgsxjxfzmnl_simazhao_prefix: "阴间SP",
	...
	sgsxjxfzmnl_mbxiezheng_info: "结束阶段，你可以令一名角色将随机一张手牌置于牌堆顶，然后你视为<span class=yellowtext>对任意名角色依次</span>使用一张【兵临城下】。<span style=\"text-decoration: line-through;\">然后若此牌若未造成伤害，你失去1点体力。</span>",
	...
	sgsxjxfzmnl_fujian_info: "锁定技，准备阶段和结束阶段，你观看一名随机的其他角色的手牌。",

	sgsxjxfzmnl_mo_jiaxu:'魔贾诩',
	sgsxjxfzmnl_mo_jiaxu_prefix:'魔',
	sgsxjxfzmnl_wansha: "完杀",//其实是处于
	sgsxjxfzmnl_wansha_info: "锁定技，<span class=firetext>当有角色进入濒死状态时，</span>除你以外，不处于濒死状态的角色不能使用【桃】。",
	sgsxjxfzmnl_luanwu: "乱武",
	sgsxjxfzmnl_luanwu_info: "限定技，出牌阶段，你可令除你外的所有角色依次对与其距离最近的另一名角色使用一张【杀】，否则失去1点体力。<span class=yellowtext>没有一名角色因此失去体力时，你摸一张牌。</span>",
	...
	sgsxjxfzmnl_xinfu_lveming_info: "出牌阶段限一次，你可以选择一名装备区装备比你少的角色，令其选择一个点数，然后你进行判定：<br>若点数相同，你<span class=yellowtext>获得其装备区所有牌，</span>对其造成2点伤害；<br>若点数不同，则你随机获得其<span class=yellowtext>每</span>区域内的<span class=yellowtext>嗝</span>一张牌。",
